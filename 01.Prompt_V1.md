...
- Prefer a technology stack centered on Python 3.10, Next.js, SQLite, and WebGPU or WebGL when those technologies are relevant to the software described in `Project_description.md`.
